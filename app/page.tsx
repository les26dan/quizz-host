...
const RAW = [
  ...
  [55,"Nhằm 'phát triển b���n vững', giai cấp công nhân Việt Nam cần nâng cao yếu tố nào?",["Nhận thức chính trị","Đạo đức nghề nghiệp","Đạo đức sinh thái","Trình độ tay nghề"],2,2],
  ...
  [112,"Yếu tố nào có ý nghĩa quan trọng nhất trong vi��c thực thi nhà nước pháp quyền?",["Đề cao phục lợi xã hội","Tôn trọng tự do cá nhân","Phát huy quyền bình đẳng","Thượng tôn pháp luật"],3,4],
